  ...
  return (
    ...
    >
     <motion.h3
      ...
      >
        Meeran Mohideen. <span>I build things for the web</span>
      </motion.h1>
      <motion.p
       initial={{ y: 10, opacity: 0 }}
       animate={{ y: 0, opacity: 1 }}
      ...
      >
        ...
        nesciunt modi, doloremque exercitationem laudantium sunt tenetur iusto.
        Labore excepturi eaque sunt blanditiis reprehenderit quam iusto
        exercitationem delectus voluptatum omnis!Lorem.{" "}
