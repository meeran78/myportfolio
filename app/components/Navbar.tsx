    ...
    >
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
        ...
        <div className="hidden mdl:inline-flex items-center gap-7 ">
          ...
          <a href="/assets/Meeran_Resume.pdf" target="_blank">
            <motion.button
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
                ...
                <div className="flex flex-row gap-4 text-textLight">
                  <div className="flex flex-row gap-4">
                    <motion.a
                      ...
                      href="https://github.com/meeran78/"
                      target="_blank"
                    >
                      <span
                ...
                hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300"
                  ...
                  <div className="flex flex-row gap-4">
                    <motion.a
                      ...
                      animate={{ y: 0, opacity: 1 }}
                      transition={{ delay: 1, ease: "easeIn" }}
                      href="https://youtub.com/meeranchennnai/"
                      target="_blank"
                    >
                      <span
                        className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center
                hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300"
                  ...
                  <div className="flex flex-row gap-4">
                    <motion.a
                      ...
                      animate={{ y: 0, opacity: 1 }}
                      transition={{ delay: 1, ease: "easeIn" }}
                      href="https://linkedin.com/meeran-mohideen-2b836964/"
                      target="_blank"
                    >
                      <span
                        className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center
                hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300"
                  ...
                  <div className="flex flex-row gap-4">
                    <motion.a
                      ...
                      animate={{ y: 0, opacity: 1 }}
                      transition={{ delay: 1, ease: "easeIn" }}
                      href="https://facebook.com/meeran.mohideen.5203/"
                      target="_blank"
                    >
                      <span
                        className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center
                hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300"
                  ...
                  <div className="flex flex-row gap-4">
                    <motion.a
                      ...
                      animate={{ y: 0, opacity: 1 }}
                      transition={{ delay: 1, ease: "easeIn" }}
                      href="https://instagram.com/meeranmohideen786786/"
                      target="_blank"
                    >
                      <span
                        className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center
